...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
		...
		$data=[];
		$data = array(
			'harwares' 		=> $this->Mdashboard->getTable("hardware"),
			'accountinfos' 	=> $this->Mdashboard->getTable("accountinfo"),
			'estatus' => $estado,
		);
		$campo ='fields_5';
	

		$datos= $this->Mdashboard->getGraphic($campo,$estado);
		...
		$campo1 ='fields_10';
		$datos1= $this->Mdashboard->getGraphic($campo1,$estado);
		...
		$campo2 ='fields_6';
		$datos2= $this->Mdashboard->getGraphic($campo2,$estado);
