    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
              ...
              <a href="<?php echo base_url();?>maintenance/Cmodel/create" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span> Agregar </a>
              <?php endif; ?>
              ...
              <table id="example1" class="table text-nowrap datatable table-hover">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          ?> 
                          <?php $datacategoria = $model->id."*".$model->name."*".$model->status?>
                          <td>
                              <div class="btn-group">
                              ...
                              <?php if($permisos->pupdate == 1): ?>
                               <a href="<?php echo base_url();?>maintenance/Cmodel/edit/<?php echo $model->id; ?>" class="btn btn-warning btn-flat">
                                  <span class="fa fa-pencil"></span>
                              </a>
                              <?php endif; ?>
                              <?php if($permisos->pdelete == 1): ?>
                               <a href="<?php echo base_url();?>maintenance/Cmodel/destroy/<?php echo $model->id; ?>" class="btn btn-danger btn-remove btn-flat">
